...
const ForgotPassword = () => {
  ...
  return (
    <div className="grid place-items-center min-h-[calc(100vh-3.5rem) mt-20">
      {loading ? (
        <div className="spinner"></div>
      ) : (
        <div className="max-w-[500px] p-4 lg:p-8">
          <h1 className="text-[1.875rem] font-semibold leading-[2.375rem] text-richblack-5">{!emailSent ? "Reset Your Password" : "Check Your Email"}
          </h1>
