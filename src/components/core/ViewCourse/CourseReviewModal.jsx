...
const CourseReviewModal = ({setReviewModal}) => {
  ...
  return (
    <div className='fixed grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm'>
      <div className='my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800'>
        <div className='flex items-start justify-between rounded-t-lg bg-richblack-700 p-5'>
