...
const VideoDetails = () => {
    ...
    ;(async () => {
      ...
      if(!courseId && !sectionId && !subSectionId) {
        ...
        const filteredVideoData = filteredData?.[0]?.subSection.filter(
          ...
          console.log(filteredData?.[0]?.subSection)
        )
  ...
  const isFirstVideo = () => {
    ...
    console.log("hiiiiiiiiiiiiii",currentSubSectionIndex)
      ...
      {!videoData ? (
        ...
        {videoEnded && (
          ...
          <div className="mt-10 flex min-w-[250px] justify-center gap-x-4 text-xl">
            ...
            {!isLastVideo() && (
              <button disabled={loading} onClick={goToNextVido} className="blackButton">Next</button>
            )}
          </div>
          </div>
        )}
...
//     console.log("sub",courseSectionData)
