        ...
        <div className='my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
          ...
          <div className='flex flex-col gap-5 lg:flex-row'>
            <div className='flex flex-col gap-2 lg:w-[48%]'>
              <lable htmlFor="FirstName" className="lable-style">
                First Name
              </lable>
              <input
                type='text'
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <lable htmlFor="lastName" className="lable-style">
                Last Name
              </lable>
              <input
                type='text'
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <lable htmlFor="dateOfBirth" className="lable-style">Date of Birth</lable>
              <input
                type='date'
                name='dateOfBirth'
                id='dateOfBirth'
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <lable htmlFor="gender" className="lable-style">Gender</lable>
              <select
              type='text'
                name='gender'
                id='gender'
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <lable htmlFor="about" className="lable-style">
                About
              </lable>
              <input
                type='text'
